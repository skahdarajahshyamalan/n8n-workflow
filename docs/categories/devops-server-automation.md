...
|----------|-------------|
| [Linux System Update via Webhook](https://github.com/enescingoz/awesome-n8n-templates/blob/main/devops/linux-update-via-webhook.json) | Trigger update and upgrade of your Debian-based server via an authenticated POST request and SSH. |
| [Docker Compose Controller via Webhook](https://github.com/enescingoz/awesome-n8n-templates/blob/main/devops/docker-compose-controller.json) | Start or stop Docker Compose services on your server via authenticated HTTP POST request with n8n and SSH. |
...
5. Set up webhook authentication (header auth or basic auth)
